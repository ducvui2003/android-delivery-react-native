...
export default function SolarClipboardListBold(props: SvgProps) {
    return (<Svg width={20} height={20} viewBox="0 0 24 24" {...props}>
        <Path fill="currentColor"
              d="M9.5 2A1.5 1.5 0 0 0 8 3.5v1A1.5 1.5 0 0 0 9.5 6h5A1.5 1.5 0 0 0 16 4.5v-1A1.5 1.5 0 0 0 14.5 2z"></Path>
