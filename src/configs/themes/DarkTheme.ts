...
const background_bottom_sheet = ColorFactory.createSingleColor(
  primary.getColor("500")
);
...
// Home
const home_category_background = ColorFactory.createSingleColor(
  neutral.getColor("700")
);
const home_category_text = ColorFactory.createSingleColor(
  neutral.getColor("100")
);
...
const home_product_card_background = ColorFactory.createSingleColor(
  neutral.getColor("500")
);
const home_product_card_text = ColorFactory.createSingleColor(
  neutral.getColor("100")
);
